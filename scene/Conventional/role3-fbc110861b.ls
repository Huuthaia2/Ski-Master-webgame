						...
						"layers":[
							{
								...
								"states":[
									{
										"name":"stand",
										"clipPath":"Assets/model/role/05/stand-stand.lani"
									},
									{
										"name":"walk",
										"clipPath":"Assets/model/role/05/walk-walk.lani"
									},
									{
										"name":"run",
										"clipPath":"Assets/model/role/05/run-run.lani"
									},
									{
										"name":"turnleft",
										"clipPath":"Assets/model/role/05/turnleft-turnleft.lani"
									},
									{
										"name":"turnright",
										"clipPath":"Assets/model/role/05/turnright-turnright.lani"
									},
									{
										"name":"sky",
										"clipPath":"Assets/model/role/05/sky-sky.lani"
									},
									{
										"name":"die",
										"clipPath":"Assets/model/role/05/die-die.lani"
									},
									{
										"name":"idle",
										"clipPath":"Assets/model/role/05/idle-idle.lani"
									}
								]
							}
						],
				...
				"child":[
					...
					},
					{
						...
						"props":{
							...
							"materials":[
								{
									"path":"Assets/model/role/05/nand05.lmat"
								}
							],
							"meshPath":"Assets/model/role/05/skin-Sphere001.lm"
						},
						"components":[],
						"child":[]
					}

						...
						"layers":[
							{
								...
								"states":[
									{
										"name":"stand",
										"clipPath":"Assets/model/role/06/stand-stand.lani"
									},
									{
										"name":"walk",
										"clipPath":"Assets/model/role/06/walk-walk.lani"
									},
									{
										"name":"turnleft",
										"clipPath":"Assets/model/role/06/turnleft-turnleft.lani"
									},
									{
										"name":"turnright",
										"clipPath":"Assets/model/role/06/turnright-turnright.lani"
									},
									{
										"name":"sky",
										"clipPath":"Assets/model/role/06/sky-sky.lani"
									},
									{
										"name":"die",
										"clipPath":"Assets/model/role/06/die-die.lani"
									},
									{
										"name":"idle",
										"clipPath":"Assets/model/role/06/idle-idle.lani"
									},
									{
										"name":"run",
										"clipPath":"Assets/model/role/06/run-run.lani"
									}
								]
							}
						],
				...
				"child":[
					...
					},
					{
						...
						"props":{
							...
							"materials":[
								{
									"path":"Assets/model/role/06/nans06.lmat"
								}
							],
							"meshPath":"Assets/model/role/06/nans06-Sphere001.lm"
						},
						"components":[],
						"child":[]
					}
